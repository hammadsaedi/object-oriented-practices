package Lab_Tasks.Lab_4.Part_2.Task_4;
...
public class Student {
    ...
    public int compareAverage(Student obj){
        if (this.average() > obj.average()) return 1;
        if (this.average() < obj.average()) return -1;
        return 0;
    }
